...
<body class="">
    ...
    <main class="main-content  mt-0">
        <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg"
            style="background-image: url('{{ asset('https://images.hdqwalls.com/wallpapers/marshmello-concert-4k-tj.jpg') }}'); background-position: center;">
            <span class="mask bg-gradient-dark opacity-6"></span>
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-5 text-center mx-auto">
                        <h1 class="text-white mb-2 mt-5">Đăng kí</h1>
                        <p class="text-lead text-white">Đăg kí để hưởng ưu đãi từ chúng tôi. Music is life</p>
                    </div>
                </div>
            </div>
        </div>
