    ...
    <aside
        ...
        <div class="w-auto sidebar" id="sidenav-collapse-main">
            <ul class="navbar-nav" id="nav_accordion">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->is('admin/post/index') ? 'active' : '' }}" href="{{url('admin/post/index')}}">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">

                            <i class="ri-git-repository-line text-success text-sm opacity-10"></i>
                        </div>
                        <span class="nav-link-text ms-1">Post</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ request()->is('admin/category/index') ? 'active' : '' }}"  href="{{url('admin/category/index')}}">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
...
{{--                            <i class="ri-ancient-gate-fill text-sm opacity-10"></i>--}}
{{--                        </div>--}}
{{--                        <span class="nav-link-text ms-1">Trang user</span>--}}
{{--                    </a>--}}
{{--                </li>--}}
                <li class="nav-item">
